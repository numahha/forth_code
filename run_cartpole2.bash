...
cd result_apply
mv current_state_1.csv current_state_2.csv
mv real_world_samples_input_1.csv real_world_samples_input_2.csv
mv real_world_samples_output_1.csv real_world_samples_output_2.csv
mv cost_1.csv cost_2.csv
cd ../
python3 apply_policy_cartpole.py --loop_num 1 --num_hidden=$hidden_num
...
for i in {2..5}; do
 ...
 if [ $policy_mode = 5 ]; then
    ...
    for j in {1..2}; do
      ...
      python3 gather_sample.py --loop_num $i
      python3 apply_policy_cartpole_simulation.py --loop_num $i --sim_env_type 1 --num_hidden=$hidden_num
      python3 apply_policy_cartpole_simulation.py --loop_num $i --sim_env_type 2 --num_hidden=$hidden_num
